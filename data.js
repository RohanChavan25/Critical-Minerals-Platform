...
DB.tab_chain = {
  ...
  sections: [
    ...
    {
      id: "chain_53",
      label: { en: "5.4 — The De-risking Toolkit", mr: "५.४ — डी-रिस्किंग साधन संच" },
      ...
      toolkitOverview: {
        ...
        items: [
          { name: { en: "1. Reshoring mining & processing", mr: "१. खाणकाम आणि प्रक्रिया पुन्हा देशात आणणे" }, body: { en: "Building new domestic mines and refineries (e.g. MP Materials in the US, Lynas in Australia, KABIL/NCMM in India). Slowest tool -- constrained by the multi-year lead times covered in 5.0, 5.0.1, and 5.5.", mr: "नवीन देशांतर्गत खाणी आणि शुद्धीकरण सुविधा उभारणे. सर्वात संथ साधन -- ५.०, ५.०.१ आणि ५.४ मध्ये समाविष्ट बहु-वर्षीय कालमर्यादेमुळे मर्यादित." }, seeAlso: "Stage 1, Stage 2, 5.5" },
          { name: { en: "2. Friend-shoring & overseas acquisition", mr: "२. मित्र-देशीकरण आणि परदेशी संपादन" }, body: { en: "Securing equity stakes or offtake in allied/partner countries (KABIL in Argentina/Australia, MSP, JOGMEC's model). Faster than building from scratch, but still subject to the same project-level lead times once the asset itself needs developing.", mr: "सहयोगी/भागीदार देशांमध्ये इक्विटी हिस्सेदारी किंवा ऑफटेक सुरक्षित करणे. सुरवातीपासून तयार करण्यापेक्षा वेगवान, पण मालमत्ता विकसित करताना त्याच प्रकल्प-स्तरीय कालमर्यादेच्या अधीन." }, seeAlso: "Stage 2, Tab 4 player cards" },
...
// ══════════════════════════════════════════════
// TAB 5 — STAGE-BY-STAGE DEEP DIVES (Stage 1 = Exploration through Stage 5 = Manufacturing)
// Rendered via buildStageList() (5.0-5.0.4) and
// renderInvestmentTimeline() (5.5) in app.js.
// ══════════════════════════════════════════════
DB._rawChainStages = [
    {
      id: "chain_50",
      label: { en: "Stage 1 — Exploration", mr: "टप्पा १ — शोध" },
    ...
    {
      id: "chain_501",
      label: { en: "Stage 2 — Mining", mr: "टप्पा २ — खाणकाम" },
    ...
    {
      id: "chain_502",
      label: { en: "Stage 3 — Processing & Separation", mr: "टप्पा ३ — प्रक्रिया आणि विभाजन" },
    ...
    {
      id: "chain_503",
      label: { en: "Stage 4 — Refining & Material Production", mr: "टप्पा ४ — शुद्धीकरण आणि सामग्री उत्पादन" },
    ...
    {
      id: "chain_504",
      label: { en: "Stage 5 — Manufacturing", mr: "टप्पा ५ — उत्पादन" },
...
DB.tab_minerals = {
  ...
  posLabels: {
    ...
    "Reviving / Pre-Commercial": { en: "Reviving / Pre-Commercial", mr: "पुनरुज्जीवन / व्यावसायिक-पूर्व" }
  },
  detailLabels: {
